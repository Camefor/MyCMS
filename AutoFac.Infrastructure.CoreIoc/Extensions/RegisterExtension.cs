...
namespace AutoFac.Infrastructure.CoreIoc.Extensions {
    ...
    public static class RegisterExtension {
        ...
        public static void AddMyServices(this IServiceCollection services) {
            ...
            //services.AddScoped<IBaseRepository<Advertisement>, BaseRepository<Advertisement>>();

            ////注册Service
            //services.AddScoped<IBlogArticleServices, BlogArticleServices>();
        ...
        public static IServiceCollection AddAssemblyServices(this IServiceCollection services,
            Assembly assembly, ServiceLifetime serviceLifetime = ServiceLifetime.Scoped) {
        ...
        /// <param name="serviceLifetime"></param>
        private static void AddServiceWithLifeScoped(this IServiceCollection services,
            Type interfaceType, Type instanceType, ServiceLifetime serviceLifetime) {
...
//    //注册DbContext
//    //services.AddScoped<XXXDbContex>();
//}
